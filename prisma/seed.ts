...
async function main() {
  ...
  const pkgs = [
    {
      name: 'VIP1',
      slug: 'VIP-1',
      description: '90-day structured yield',
      dailyYieldPercent: '6',
      maturityDays: 90,
      minAmount: '3000',
      maxAmount: '2000000',
  ...
  const vipDefs = [
    { level: 0, levelName: 'Member', minInvestmentRequired: '0', minTeamMembers: 0, minCommissionEarned: '0', dividendRate: '0', weeklySalary: '0', membersUnlockCount: 0, maxWithdrawalPercent: '20' },
